...
import com.pingwin.compiler.core.methods.Method;
import com.pingwin.compiler.core.methods.MethodType;
import com.pingwin.compiler.core.variables.Variable;
import com.pingwin.compiler.core.variables.VariableType;
...
public class PingwinLanguageVisitorImplV1 implements PingwinLanguageVisitor<String> {

    private final PingwinLanguageParserV1 parserV1;
    private final VariableAndMethodRegister register = new VariableAndMethodRegister();
    private final String name;

    public PingwinLanguageVisitorImplV1(PingwinLanguageParserV1 parserV1, String name) {
        this.parserV1 = parserV1;
        this.name = name;
    }

    @Override
    public String visitProgram(PingwinLanguageParser.ProgramContext ctx) {
    ...
    @Override
    public String visitBlock(PingwinLanguageParser.BlockContext ctx) {
    ...
    private StringBuilder invokeAllStatementsForBlock(List<PingwinLanguageParser.StatementContext> list) {
    ...
    @Override
    public String visitStatement(PingwinLanguageParser.StatementContext ctx) {
    ...
    @Override
    public String visitDigit_expression(PingwinLanguageParser.Digit_expressionContext ctx) {
        validateDigitExpression(ctx);
        return concatExpr(ctx) + CompilerFields.SEPARATOR;
    }

    @Override
    public String visitIntialize_set(PingwinLanguageParser.Intialize_setContext ctx) {
        String ID = ((PingwinLanguageParser.Assign_setContext) ctx.parent).ID().getText();
    ...
    @Override
    public String visitIntialize_element(PingwinLanguageParser.Intialize_elementContext ctx) {
        return String.format(CompilerFields.NEW_ELEMENT, ctx.STRING()) + CompilerFields.SEPARATOR;
    }

    @Override
    public String visitAssign_var_method_invocation(PingwinLanguageParser.Assign_var_method_invocationContext ctx) {
    ...
    private void validateDigitExpression(PingwinLanguageParser.Digit_expressionContext ctx) {
        if (ctx.ID() != null) {
        ...
        List<PingwinLanguageParser.Digit_expressionContext> expr = ctx.digit_expression();
    ...
    @Override
    public String visitAssign_var(PingwinLanguageParser.Assign_varContext ctx) {
        return processAssignVar(ctx, false);
    }

    private String processAssignVar(PingwinLanguageParser.Assign_varContext ctx, boolean global) {
    ...
    @Override
    public String visitAssign_set(PingwinLanguageParser.Assign_setContext ctx) {
        return processAssignSet(ctx, false);
    }

    private String processAssignSet(PingwinLanguageParser.Assign_setContext ctx, boolean global) {
        StringBuilder out = new StringBuilder();
    ...
    @Override
    public String visitPrint(PingwinLanguageParser.PrintContext ctx) {
        if (ctx.ID() != null) {
    ...
    @Override
    public String visitOperations(PingwinLanguageParser.OperationsContext ctx) {
        Variable variable = register.getVariable(ctx.ID().toString());
    ...
    @Override
    //TODO rework.
    public String visitOperarions_with_set(PingwinLanguageParser.Operarions_with_setContext ctx) {
    ...
    @Override
    public String visitSimple_compare(PingwinLanguageParser.Simple_compareContext ctx) {
        List<PingwinLanguageParser.Digit_expressionContext> dctx = ctx.digit_expression();
    ...
    @Override
    public String visitHard_compare(PingwinLanguageParser.Hard_compareContext ctx) {
        return ctx.NEGATION().getText() + ctx.O_BRACKET().getText() + visitSimple_compare(ctx.simple_compare()) + ctx.C_BRACKET().getText();
    }

    @Override
    public String visitWhile_cicle(PingwinLanguageParser.While_cicleContext ctx) {
    ...
    private String handlerCompare(PingwinLanguageParser.Hard_compareContext htx, PingwinLanguageParser.Simple_compareContext stx) {
        return stx == null ? htx.accept(this) : stx.accept(this);
    }

    @Override
    public String visitIf_then(PingwinLanguageParser.If_thenContext ctx) {
    ...
    @Override
    public String visitFor_each(PingwinLanguageParser.For_eachContext ctx) {
    ...
    @Override
    public String visitGlobal_assign_set(PingwinLanguageParser.Global_assign_setContext ctx) {
        return CompilerFields.GLOBAL_VAR + processAssignSet(ctx.assign_set(), true);
    }

    @Override
    public String visitGlobal_assign_var(PingwinLanguageParser.Global_assign_varContext ctx) {
        return CompilerFields.GLOBAL_VAR + processAssignVar(ctx.assign_var(), true);
    }

    @Override
    public String visitType(PingwinLanguageParser.TypeContext ctx) {
    ...
    @Override
    public String visitType_1(PingwinLanguageParser.Type_1Context ctx) {
        VariableType variableType = VariableType.findByDisplayName(ctx.getText());
        return Preconditions.checkNotNull(variableType).getOutName();
    }

    @Override
    public String visitSignature(PingwinLanguageParser.SignatureContext ctx) {
    ...
    @Override
    public String visitSubprogram_return(PingwinLanguageParser.Subprogram_returnContext ctx) {
    ...
    @Override
    public String visitSubprogram_non_return(PingwinLanguageParser.Subprogram_non_returnContext ctx) {
        Method method = register.getRegisteredMethod(ctx.ID().toString());
        if (method == null || method.getMethodType() != MethodType.RETURN_OPTIONAL) {
            throw new UnsupportedOperationException();
        }
    ...
    private String handleSignature(PingwinLanguageParser.SignatureContext ctx) {
        return ctx == null ? CompilerFields.OPEN_BRACKET + CompilerFields.CLOSE_BRACKET : ctx.accept(this);
    }

    @Override
    public String visitBlock_return(PingwinLanguageParser.Block_returnContext ctx) {
        register.registerNew​​VisibilityArea();
        Method method = Preconditions.checkNotNull(register.getRegisteredMethod(((PingwinLanguageParser.Subprogram_returnContext) ctx.parent).ID().getText()));
        StringBuilder out = new StringBuilder(CompilerFields.BEGIN).append(invokeAllStatementsForBlock(ctx.statement()));
    ...
    @Override
    public String visitBlock_non_return(PingwinLanguageParser.Block_non_returnContext ctx) {
        register.registerNew​​VisibilityArea();
        StringBuilder out = new StringBuilder(CompilerFields.BEGIN).append(invokeAllStatementsForBlock(ctx.statement()));
        out.append(CompilerFields.RETURN);
    ...
    @Override
    public String visitSignature_method_invokation(PingwinLanguageParser.Signature_method_invokationContext ctx) {
        StringBuilder builder = new StringBuilder();
        builder.append(CompilerFields.OPEN_BRACKET);
        Method method = register.getRegisteredMethod(((PingwinLanguageParser.Method_invokationContext) ctx.parent).ID().getText());
    ...
    @Override
    public String visitMethod_invokation(PingwinLanguageParser.Method_invokationContext ctx) {
        Method method = register.getRegisteredMethod(ctx.ID().toString());
        if (method == null) {
            throw new UnsupportedOperationException();
        }
    ...
    private String handleSignatureOfInvocation(PingwinLanguageParser.Method_invokationContext ctx) {
    ...
    @Override
    public String visitGlobal_program(PingwinLanguageParser.Global_programContext ctx) {
        StringBuilder out = new StringBuilder();
        register.registerMethod(new Method(CompilerFields.MAIN_PROGRAM, MethodType.RETURN_OPTIONAL, Collections.emptyList()));
        List<PingwinLanguageParser.Subprogram_non_returnContext> non_returnContexts = ctx.subprogram_non_return();
        List<PingwinLanguageParser.Subprogram_returnContext> returnContexts = ctx.subprogram_return();
        for (PingwinLanguageParser.Global_assign_varContext ct : ctx.global_assign_var()) {
            out.append(ct.accept(this));
        }
        for (PingwinLanguageParser.Global_assign_setContext ct : ctx.global_assign_set()) {
            out.append(ct.accept(this));
        }
        for (PingwinLanguageParser.Subprogram_returnContext ct : returnContexts) {
        ...
        for (PingwinLanguageParser.Subprogram_non_returnContext ct : non_returnContexts) {
    ...
    private List<VariableType> collectMethodArguments(PingwinLanguageParser.SignatureContext ctx) {
