package com.pingwin.compiler.core.variables;
...
public enum VariableType {
    ...
    INT("int", "int", (ctx, visitor) -> {
        return ((PingwinLanguageParser.Assign_varContext)ctx).digit_expression().accept(visitor);
    }),
    ELEMENT("element", "Element", (ctx, visitor) -> {
        return ((PingwinLanguageParser.Assign_varContext)ctx).intialize_element().accept(visitor);
    }),
    SET("set", "Set", (ctx, visitor) -> {
        return ((PingwinLanguageParser.Assign_setContext)ctx).intialize_set().accept(visitor);
    }),;
